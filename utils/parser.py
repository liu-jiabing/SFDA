...
def create_parser():#用于创建命令行参数解析器
    ...
    parser.add_argument('--res_dir', default='work_dirs_mmnist_cifar', type=str)
    ...
    parser.add_argument('--data_root', default='/scratch/jiabing/data')
    parser.add_argument('--dataname', '-d', default='weather_r_5_625', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'weather_r_1_40625', 'weather_uv10_1_40625', 'weather_tcc_1_40625','weather_tp_6_625',
                                'sevir_vis', 'sevir_ir069', 'sevir_ir107', 'sevir_vil','weather_tp_5_625', 'weather_tcc_2_8125'],
    ...
    parser.add_argument('--epoch', '-e', default=None, type=int, help='end epochs (default: 50)')
...
def default_parser():#获取默认配置
    default_values = {
        # Set-up parameters
        'device': 'cuda',
        'dist': False,
        'res_dir': 'work_dirs_mmnist_cifar',
        'ex_name': 'Debug',
        'fp16': False,
        'torchscript': False,
        'seed': 42,
        ...
        # 在配置文件中添加 num_hidden 参数
        # 在配置文件中定义 num_hidden 参数
